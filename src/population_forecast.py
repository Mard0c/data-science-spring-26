...
# Load Data
df_gap = pd.read_csv("interim_csvs/forecast_results_all_states.csv")
pop = pd.read_csv("interim_csvs/cleaned_population_2015-2024.csv", sep=';')
...
pop_forecast.to_csv("interim_csvs/population_forecast.csv", index=False)
